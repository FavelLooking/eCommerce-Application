...
function ShippingPostalCodeInput({
  onValidationChange,
  selectedCountry,
  ...
  return (
    <label
      className="registration-input shipping-postal-code-input"
      htmlFor="billing-postal-code-input"
    >
      <p className="registration-input__shipping-postal-code-lable">
        postal code:
      </p>
      <input
...
export default ShippingPostalCodeInput;
